                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                        ...
                        <div className="lg:col-span-7 text-white">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <button onClick={handleBecomeVendor} className="btn-primary-mobile text-white font-semibold px-8 py-3 rounded-2xl hover:from-pink-600 hover:to-pink-700 transition-all duration-300 shadow-lg transform hover:scale-105 flex items-center justify-center text-center bg-gradient-brand">
                                    Become a Vendor
                                </button>
                            </div>
                        </div>
                            ...
                            <div className="bg-white rounded-2xl shadow-2xl p-8 transform lg:translate-y-16 lg:mb-16">
                                ...
                                <form onSubmit={handleLogin} className="space-y-6">
                                    ...
                                    <button
                                        type="submit"
                                        disabled={loading}
                                        className="w-full btn-primary-mobile text-white font-semibold py-3 rounded-2xl hover:from-pink-600 hover:to-pink-700 transition-all duration-300 shadow-lg transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed bg-gradient-brand"
                                    >
